import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, ref, getCurrentInstance, hasInjectionContext, inject, toRef, isRef, shallowRef, provide, cloneVNode, h, createElementBlock, computed, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, createApp, createVNode, Text, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
import { y as defuFn, d as destr, z as klona, q as createError$1, A as parse$1, B as getRequestHeader, C as isEqual$1, D as sanitizeStatusCode, E as setCookie, F as getCookie, G as deleteCookie, H as getContext, $ as $fetch$1, I as baseURL, J as createHooks, K as executeAsync, L as toRouteMatcher, M as createRouter$1, N as defu, O as getRequestURL, P as createDefu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index___en",
    path: "/",
    component: () => import('./index-v_krmMRq.mjs')
  },
  {
    name: "index___id",
    path: "/id",
  ...
  },
  {
    ...
    component: () => import('./login-CTfkXIvc.mjs')
  },
  {
    name: "login___id",
    path: "/id/login",
  ...
  },
  {
    ...
    component: () => import('./register-C9mtdK_8.mjs')
  },
  {
    name: "register___id",
    path: "/id/register",
  ...
  {
    name: "admin-dbobject___en",
    path: "/admin/dbobject",
    component: () => import('./dbobject-BHOxJk8D.mjs')
  },
  {
    name: "admin-dbobject___id",
    path: "/id/admin/dbobject",
    component: () => import('./dbobject-BHOxJk8D.mjs')
  },
  {
    name: "admin-mediamgr___en",
    path: "/admin/mediamgr",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./mediamgr-BpUu8Pq1.mjs')
  },
  {
    name: "admin-mediamgr___id",
    path: "/id/admin/mediamgr",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./mediamgr-BpUu8Pq1.mjs')
  },
  {
    name: "admin-slug___en",
    path: "/admin/:slug(.*)*",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": ["auth"] } },
    component: () => import('./_...slug_-xI9dJF1n.mjs')
  },
  {
    name: "admin-slug___id",
    path: "/id/admin/:slug(.*)*",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": ["auth"] } },
    component: () => import('./_...slug_-xI9dJF1n.mjs')
  },
  {
    ...
    component: () => import('./dashboard-flvmiizB.mjs')
  },
  {
    name: "admin-dashboard___id",
  ...
  },
  {
    ...
    path: "/articles/:slug()",
    component: () => import('./_slug_-ly4zjHmZ.mjs')
  },
  {
    name: "articles-slug___id",
    path: "/id/articles/:slug()",
    component: () => import('./_slug_-ly4zjHmZ.mjs')
  },
  {
    name: "admin-theme-editor-slug___en",
    path: "/admin/theme-editor/:slug(.*)*",
    component: () => import('./_...slug_-wJsNjiv0.mjs')
  },
  {
    name: "admin-theme-editor-slug___id",
    path: "/id/admin/theme-editor/:slug(.*)*",
    component: () => import('./_...slug_-wJsNjiv0.mjs')
  },
  {
    name: "admin-form-designer-slug___en",
    path: "/admin/form-designer/:slug(.*)*",
    meta: { "middleware": ["auth"] },
    component: () => import('./_...slug_-DUCR0dsT.mjs')
  },
  {
    name: "admin-form-designer-slug___id",
    path: "/id/admin/form-designer/:slug(.*)*",
    meta: { "middleware": ["auth"] },
    component: () => import('./_...slug_-DUCR0dsT.mjs')
  },
  {
    name: "admin-widget-designer-slug___en",
    path: "/admin/widget-designer/:slug(.*)*",
    meta: { "middleware": ["auth"] },
    component: () => import('./_...slug_-DiED8gpl.mjs')
  },
  {
    name: "admin-widget-designer-slug___id",
    path: "/id/admin/widget-designer/:slug(.*)*",
    meta: { "middleware": ["auth"] },
    component: () => import('./_...slug_-DiED8gpl.mjs')
  },
  {
    name: "admin-workflow-designer-slug___en",
    path: "/admin/workflow-designer/:slug(.*)*",
    meta: { "middleware": ["auth"] },
    component: () => import('./_...slug_-Drj973pP.mjs')
  },
  {
    name: "admin-workflow-designer-slug___id",
    path: "/id/admin/workflow-designer/:slug(.*)*",
    meta: { "middleware": ["auth"] },
    component: () => import('./_...slug_-Drj973pP.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-BiiDXADa.mjs').then((r) => r["default"] || r.default || r));
  ...
  en: [
    {
      ...
      load: () => import(
        './en-D2HNIGkF.mjs'
        /* webpackChunkName: "locale_en_46json_d7e91c93" */
      ),
      cache: true
    }
  ],
  id: [
    {
      ...
      load: () => import(
        './id-DoyLuB0Q.mjs'
        /* webpackChunkName: "locale_id_46json_f3b64fa6" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`/_i18n/${"yX5BpkGQ"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `/_i18n/${"yX5BpkGQ"}/${locale}/messages.json`));
...
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-CbseSO5F.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-CCBsmGMz.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Uiv6PK8X.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bg8xZ8RQ.mjs'));
...
export { useCookie as A, _export_sfc as _, useI18n as a, useRoute as b, useRuntimeConfig as c, appConfig as d, entry$1 as default, encodeParam as e, encodePath as f, useNuxtApp as g, hasProtocol as h, useRequestEvent as i, joinURL as j, useAppConfig as k, useRouter as l, parseQuery as m, navigateTo as n, withTrailingSlash as o, parseURL as p, withoutTrailingSlash as q, resolveRouteObject as r, nuxtLinkDefaults as s, useState as t, useHead as u, defineNuxtRouteMiddleware as v, withLeadingSlash as w, asyncDataDefaults as x, createError as y, __nuxt_component_0$1 as z };
