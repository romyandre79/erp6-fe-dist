import { defineComponent, ref, shallowReactive, computed, watch, nextTick, reactive, watchEffect, createVNode, resolveDynamicComponent, unref, withCtx, createBlock, openBlock, h, useSlots, toRef as toRef$1, mergeProps, renderSlot, toHandlers, createTextVNode, toDisplayString, createCommentVNode, inject, toRaw, toValue, Fragment, renderList, isRef, toRefs, provide, mergeModels, useModel, useAttrs, withModifiers, shallowRef, getCurrentInstance, useSSRContext, readonly, customRef } from 'vue';
import { ssrRenderList, ssrRenderVNode, ssrRenderStyle, ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrRenderClass, ssrRenderAttrs, ssrIncludeBooleanAttr, ssrRenderAttr, ssrRenderDynamicModel, ssrLooseContain, ssrLooseEqual } from 'vue/server-renderer';
import { useForwardPropsEmits, DialogRoot, DialogTrigger, DialogPortal, DialogOverlay, DialogContent, VisuallyHidden, DialogTitle, DialogDescription, DialogClose, useForwardProps, Primitive, Slot, TabsRoot, TabsList, TabsIndicator, TabsTrigger, TabsContent, useFilter, ComboboxItem, ComboboxLabel, ComboboxSeparator, ComboboxItemIndicator, ComboboxRoot, ComboboxAnchor, ComboboxTrigger, ComboboxPortal, ComboboxContent, FocusScope, ComboboxInput, ComboboxEmpty, ComboboxVirtualizer, ComboboxGroup, ComboboxArrow } from 'reka-ui';
import { Q as serialize, N as defu, C as isEqual } from '../_/nitro.mjs';
import { createTV } from 'tailwind-variants';
import { a as useI18n, k as useAppConfig, n as navigateTo, d as appConfig, b as useRoute, u as useHead, g as useNuxtApp, c as useRuntimeConfig, w as withLeadingSlash, h as hasProtocol, j as joinURL, p as parseURL, e as encodeParam, f as encodePath } from './server.mjs';
import __nuxt_component_0$2 from './index-BiiDXADa.mjs';
import { u as useToast } from './useToast-CmqKK4ER.mjs';
import { u as useApi } from './useApi-2vD1WDJW.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-BbHPSXWt.mjs';
...
const ipxRuntime$_5yELMI8KTUnxcQLB9AaonIE6Jzliqg1taCyC76R2rTA = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  operationsGenerator,
  supportsAlias,
...
const imageOptions = {
  ...
  providers: {
    ["ipx"]: { provider: ipxRuntime$_5yELMI8KTUnxcQLB9AaonIE6Jzliqg1taCyC76R2rTA, defaults: {} }
  }
};
...
const _sfc_main$d = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const appConfig2 = useAppConfig();
    const { size } = useAvatarGroup(props);
    const ui = computed(() => tv({ extend: tv(theme$8), ...appConfig2.ui?.avatar || {} })({
      size: size.value
    }));
...
const _sfc_main$b = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme), ...appConfig2.ui?.tabs || {} })({
      color: props.color,
      variant: props.variant,
      size: props.size,
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["action", "row-action", "fetch-params", "selection-change"],
  setup(__props, { expose: __expose, emit: __emit }) {
    const props = __props;
    const emit = __emit;
    const Api = useApi();
    ...
    const searchComplexQuery = ref({});
    const pageSize = ref(props.pageSize);
    const totalRecords = ref(0);
    const rowsData = ref([]);
    const loading = ref(false);
    const selectedKeys = ref([]);
    const isSelected = (row) => selectedKeys.value.includes(row[props.rowKey]);
    watch(
      selectedKeys,
      (val) => {
        const selectedRows2 = rowsData.value.filter((r) => val.includes(r[props.rowKey]));
        emit("selection-change", selectedRows2);
      },
      { deep: true }
    );
    ...
    const formatCellValue = (col, value) => {
      if (["boolean", "bool", "checkbox"].includes(col.type))
        return value ? '<input type="checkbox" checked disabled class="checkbox checkbox-sm"/>' : '<input type="checkbox" disabled class="checkbox checkbox-sm"/>';
    ...
    function renderTable(component) {
      ...
      return h("div", { key }, [
        h(TablePagination, {
          columns: columns?.children.map((col, i) => ({
            label: col.props.text || `Column ${i + 1}`,
            key: col.props.key || `col${i + 1}`,
            type: col.type || "text"
          })) ?? [],
          searchColumn: searchs?.children.map((col, i) => ({
            key: col.props.key || `col${i + 1}`,
            type: col.type || "text",
          ...
          selectedKeyData: component.props.relationkey != "" && selectedRows.value.length > 0 ? selectedRows.value[0][component.props.relationkey] : "",
    ...
    __expose({ refreshTable: fetchData });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full" }, _attrs))}><div class="flex flex-col mb-3"><h2 class="font-semibold">${ssrInterpolate(__props.title)}</h2>`);
      if (__props.enableSearch) {
        _push(`<div class="mt-2">`);
        if (__props.simpleSearch) {
          _push(`<div class="flex items-center gap-2"><input${ssrRenderAttr("value", searchQuery.value)} type="text" placeholder="Search..." class="border rounded px-3 py-2 text-sm w-full"><button class="px-3 py-2 bg-blue-600 text-white rounded">Cari</button></div>`);
        } else {
          _push(`<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3"><!--[-->`);
          ssrRenderList(__props.searchColumn, (col, index) => {
            _push(`<div>`);
            if (["text", "number", "email"].includes(col.type)) {
              _push(`<input${ssrRenderDynamicModel(col.type, searchComplexQuery.value[col.key], null)}${ssrRenderAttr("type", col.type)}${ssrRenderAttr("placeholder", `${_ctx.$t(col.place.toUpperCase())}...`)} class="border rounded px-3 py-2 text-sm w-full">`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
        ...
        if (__props.actions && __props.actions.length) {
          _push(`<div><!--[-->`);
          ssrRenderList(__props.actions, (action, index) => {
            _push(`<button>`);
            if (action.icon) {
              _push(`<i class="${ssrRenderClass(["mr-1", action.icon])}"></i>`);
            } else {
              _push(`<!---->`);
            }
      ...
      _push(`</div><div class="w-full rounded-xl"><table class="w-full"><thead class="text-sm uppercase font-semibold"><tr>`);
      if (__props.enableCheck && __props.isSelectAll) {
        _push(`<th class="px-4 py-3"><input type="checkbox" class="checkbox checkbox-sm"${ssrIncludeBooleanAttr(rowsData.value.length > 0 && rowsData.value.every((r) => isSelected(r))) ? " checked" : ""}></th>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.tables?.length > 1 && props.isInput == false) {
        _push(`<th class="thead px-4 py-3"></th>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      ssrRenderList(__props.columns, (col) => {
        _push(`<th class="thead px-4 py-3 text-left tracking-wide">${ssrInterpolate(col.text || col.label)}</th>`);
      });
      _push(`<!--]-->`);
      if (__props.rowActions && __props.rowActions.length) {
        _push(`<th class="thead px-4 py-3 text-left">Actions</th>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</tr></thead><tbody>`);
      if (loading.value) {
        _push(`<tr><td${ssrRenderAttr("colspan", __props.columns.length + (__props.rowActions?.length ? 1 : 0) + 1)} class="p-4 text-center"><span class="loading loading-spinner loading-md"></span></td></tr>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      ssrRenderList(rowsData.value, (row, rowIndex) => {
        _push(`<!--[--><tr class="transition-colors duration-200"${ssrIncludeBooleanAttr(isSelected(row)) ? " checked" : ""}>`);
        if (__props.enableCheck) {
          _push(`<td class="px-4 py-3"><input type="checkbox" class="checkbox checkbox-sm"${ssrIncludeBooleanAttr(isSelected(row)) ? " checked" : ""}></td>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.tables?.length > 1 && props.isInput == false) {
          _push(`<td class="px-4 py-3"><button>${ssrInterpolate(isExpanded(row) ? "-" : "+")}</button></td>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--[-->`);
        ssrRenderList(__props.columns, (col) => {
          _push(`<td class="px-4 py-3 text-sm cursor-pointer"><span>${formatCellValue(col, row[col.key || col]) ?? ""}</span></td>`);
        });
        _push(`<!--]-->`);
        if (__props.rowActions && __props.rowActions.length) {
          _push(`<td class="px-4 py-3"><!--[-->`);
          ssrRenderList(__props.rowActions, (action, i) => {
            _push(`<button class="${ssrRenderClass(["btn btn-xs mr-1", action.class || "btn-outline"])}">`);
            if (action.icon) {
              _push(`<i class="${ssrRenderClass(["mr-1", action.icon])}"></i>`);
            } else {
              _push(`<!---->`);
        ...
        _push(`</tr>`);
        if (isExpanded(row)) {
          _push(`<tr><td${ssrRenderAttr("colspan", __props.columns.length + 2)}><!--[-->`);
          ssrRenderList(__props.tables, (child, index) => {
            _push(`<div class="rounded-lg w-full">`);
            if (index > 0) {
              ssrRenderVNode(_push, createVNode(resolveDynamicComponent(renderTable(child)), null, null), _parent);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
      ...
      _push(`<!--]-->`);
      if (!loading.value && rowsData.value.length === 0) {
        _push(`<tr><td${ssrRenderAttr("colspan", __props.columns.length + (__props.rowActions?.length ? 1 : 0))} class="text-center p-4 text-gray-400"> No data available </td></tr>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</tbody></table>`);
      if (__props.enablePaging) {
        _push(`<div class="paging flex justify-center items-center gap-2"><span class="text-base-content/70"> Page ${ssrInterpolate(currentPage.value)} / ${ssrInterpolate(totalPages.value)}</span>`);
        if (__props.enablePageSize) {
          _push(`<select class="border rounded px-2 py-1 text-sm"><!--[-->`);
          ssrRenderList(__props.pageSizeOptions, (size) => {
            _push(`<option${ssrRenderAttr("value", size)}${ssrIncludeBooleanAttr(Array.isArray(pageSize.value) ? ssrLooseContain(pageSize.value, size) : ssrLooseEqual(pageSize.value, size)) ? " selected" : ""}>${ssrInterpolate(size)}</option>`);
          });
          _push(`<!--]--></select>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<button class="px-3 py-1 rounded-lg border hover:bg-base-100"${ssrIncludeBooleanAttr(currentPage.value === 1 || loading.value || totalPages.value === 0) ? " disabled" : ""}> &lt;&lt; </button><button class="px-3 py-1 rounded-lg border hover:bg-base-100"${ssrIncludeBooleanAttr(currentPage.value === 1 || loading.value || totalPages.value === 0) ? " disabled" : ""}> &lt; </button><button class="px-3 py-1 rounded-lg border hover:bg-base-100"${ssrIncludeBooleanAttr(currentPage.value === totalPages.value || loading.value) ? " disabled" : ""}> &gt; </button><button class="px-3 py-1 rounded-lg border hover:bg-base-100"${ssrIncludeBooleanAttr(currentPage.value === totalPages.value || loading.value) ? " disabled" : ""}> &gt;&gt; </button></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/TableDetailPagination.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const TableDetailPagination = Object.assign(_sfc_main$6, { __name: "TableDetailPagination" });
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full" }, _attrs))}><div class="flex flex-col sm:flex-row mb-3"><h2 class="text-2xl font-semibold">${ssrInterpolate(__props.title)}</h2>`);
      if (__props.enableSearch) {
      ...
      ssrRenderList(rowsData.value, (row, rowIndex) => {
        ...
        if (props.enableCheck) {
          ...
          if (props.isSelectAll) {
            _push(`<input type="checkbox" class="checkbox checkbox-sm"${ssrIncludeBooleanAttr(isSelected(row)) ? " checked" : ""}>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</td>`);
        ...
        _push(`</tr>`);
        if (isExpanded(row) && __props.isExpand == true) {
          _push(`<tr><td${ssrRenderAttr("colspan", __props.columns.length + 2)}><!--[-->`);
          ssrRenderList(__props.tables, (child, index) => {
            _push(`<div class="rounded-lg w-full">`);
            if (index > 0) {
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/TablePagination.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const TablePagination = Object.assign(_sfc_main$5, { __name: "TablePagination" });
...
const _sfc_main$3 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const portalProps = usePortal(toRef$1(() => props.portal));
    const contentProps = toRef$1(() => defu(props.content, { side: "bottom", sideOffset: 8, collisionPadding: 8, position: "popper" }));
    const arrowProps = toRef$1(() => props.arrow);
    const virtualizerProps = toRef$1(() => !!props.virtualize && defu(typeof props.virtualize === "boolean" ? {} : props.virtualize, {
      estimateSize: {
        xs: 24,
        sm: 28,
        md: 32,
    ...
    const searchInputProps = toRef$1(() => defu(props.searchInput, { placeholder: t("selectMenu.search"), variant: "none" }));
    ...
    const [DefineCreateItemTemplate, ReuseCreateItemTemplate] = /* @__PURE__ */ createReusableTemplate();
    ...
    const ui = computed(() => tv({ extend: tv(theme$1), ...appConfig2.ui?.selectMenu || {} })({
      color: color.value,
      variant: props.variant,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(ComboboxItem), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="${ssrRenderClass(ui.value.itemLabel({ class: props.ui?.itemLabel }))}"${_scopeId2}>`);
                ...
                default: withCtx((_, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ssrRenderSlot(_ctx.$slots, "item", {
                      ...
                      _push3(`<span class="${ssrRenderClass(ui.value.itemWrapper({ class: [props.ui?.itemWrapper, isSelectItem(item) && item.ui?.itemWrapper] }))}"${_scopeId2}><span class="${ssrRenderClass(ui.value.itemLabel({ class: [props.ui?.itemLabel, isSelectItem(item) && item.ui?.itemLabel] }))}"${_scopeId2}>`);
                      ...
                      if (isSelectItem(item) && (unref(get)(item, props.descriptionKey) || !!slots["item-description"])) {
                        _push3(`<span class="${ssrRenderClass(ui.value.itemDescription({ class: [props.ui?.itemDescription, isSelectItem(item) && item.ui?.itemDescription] }))}"${_scopeId2}>`);
                      ...
                      _push3(`</span><span class="${ssrRenderClass(ui.value.itemTrailing({ class: [props.ui?.itemTrailing, isSelectItem(item) && item.ui?.itemTrailing] }))}"${_scopeId2}>`);
                            ...
                            if (_push5) {
                              ...
                              if (!!__props.searchInput) {
                                _push5(ssrRenderComponent(unref(ComboboxInput), {
                                  ...
                                  default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(_sfc_main$4, mergeProps({
                                        autofocus: "",
                                        autocomplete: "off",
                                        size: __props.size
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col mb-3" }, _attrs))}>`);
      if (unref(component).text) {
        _push(`<label class="mb-1 text-gray-400 text-sm font-medium">${ssrInterpolate(_ctx.$t(unref(component).text.toUpperCase()))}</label>`);
      } else {
        _push(`<!---->`);
      }
      _push(ssrRenderComponent(_component_USelectMenu, {
        modelValue: modelSelect.value,
        "onUpdate:modelValue": ($event) => modelSelect.value = $event,
        items: options.value,
        "value-key": "id",
        loading: loading.value,
        placeholder: unref(component).place || _ctx.$t("CHOOSE"),
        class: "w-full px-3 py-2 focus:ring focus:ring-blue-200 outline-none border-gray-300",
        disabled: loading.value
      }, null, _parent));
      if (unref(validationErrors)[unref(component).key]) {
        _push(`<span class="text-xs text-red-500 mt-1">${ssrInterpolate(unref(validationErrors)[unref(component).key])}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const FormSelect = Object.assign(_sfc_main$2, { __name: "FormSelect" });
const _sfc_main$1 = {
  __name: "FormWizard",
  __ssrInlineRender: true,
  props: {
  ...
  emits: ["finish", "changeStep", "autosave"],
  setup(__props, { emit: __emit }) {
    const props = __props;
    const emit = __emit;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full max-w-2xl mx-auto p-6 border rounded-lg shadow bg-white" }, _attrs))}><div class="w-full bg-gray-200 h-2 rounded mb-6"><div class="h-2 bg-blue-600 rounded transition-all" style="${ssrRenderStyle({ width: progressPercent.value + "%" })}"></div></div><div class="flex justify-between mb-6"><!--[-->`);
      ssrRenderList(__props.steps, (step, i) => {
        _push(`<div class="text-center flex-1"><div class="${ssrRenderClass([i === currentStep.value ? "bg-blue-600 text-white border-blue-600" : "border-gray-400 text-gray-500", "w-10 h-10 mx-auto flex items-center justify-center rounded-full border font-bold transition"])}">${ssrInterpolate(i + 1)}</div><p class="text-xs mt-1">${ssrInterpolate(step.title)}</p></div>`);
      });
      _push(`<!--]--></div><div class="mb-6">`);
      ssrRenderSlot(_ctx.$slots, "default", {
        step: currentStep.value,
        schema: __props.steps[currentStep.value].schema,
        state: formState
      }, null, _push, _parent);
      _push(`</div>`);
      if (error.value) {
        _push(`<p class="text-red-500 mb-4">${ssrInterpolate(error.value)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex justify-between"><button class="px-4 py-2 bg-gray-300 rounded"${ssrIncludeBooleanAttr(currentStep.value === 0) ? " disabled" : ""}>Back</button>`);
      if (currentStep.value < __props.steps.length - 1) {
        _push(`<button class="px-4 py-2 bg-blue-600 text-white rounded"> Next </button>`);
      } else {
        _push(`<button class="px-4 py-2 bg-green-600 text-white rounded">Finish</button>`);
      }
      _push(`</div></div>`);
    };
  }
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/FormWizard.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const FormWizard = Object.assign(_sfc_main$1, { __name: "FormWizard" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const modalRefs = shallowReactive({});
    const tableRef = ref();
    const Api = useApi();
    const t = useI18n();
    ...
    watch(
      ...
      (tabs) => {
        tabs.forEach((t2) => {
          if (!detailRows.value[t2.key]) {
            if (t2.value && Array.isArray(t2.value)) {
              detailRows.value[t2.key] = [...t2.value];
            } else {
              detailRows.value[t2.key] = [{}];
            }
          }
        });
      },
        ...
        try {
          ...
          if (res.code == 200) {
            ...
            for (const key2 in record) {
              formData.value[key2] = record[key2];
            }
    ...
    function renderComponent(component) {
      switch (component.type) {
        case "callother":
          return renderCallOther(component);
        // <— buatkan function khusus
        case "title":
          return h(
            "h1",
            {
        ...
        case "longtext": {
          ...
          return h("div", { class: "flex flex-col mb-3" }, [
            component.type != "hidden" ? component.props.text ? h("label", { class: "mb-1 font-medium" }, t(component.props.text.toUpperCase())) : null : "",
            h("textarea", {
              type: component.type,
              class: "border rounded px-3 py-2 focus:ring focus:ring-blue-200 outline-none " + (validationErrors[component.props.key] ? "border-red-500" : "border-gray-300") + " " + (component.type === "number" ? "text-right" : ""),
              placeholder: t(component.props.place?.toUpperCase()) || "",
              maxlength: component.length,
              onInput: (e) => e.target.value,
              value: modelInputArea.value
            }),
            validationErrors[component.props.key] ? h("span", { class: "text-red-500 mt-1" }, validationErrors[component.props.key]) : null
          ]);
        }
        case "text":
        case "hidden":
        ...
        case "number": {
          ...
          return h("div", { class: component.props.class || "flex flex-col mb-3" }, [
            component.type != "hidden" ? component.props.text ? h("label", { class: "text-sm mb-1 font-medium text-gray-400" }, t(component.props.text.toUpperCase())) : null : "",
            h("input", {
              type: component.type,
              class: "border rounded px-3 py-2 focus:ring focus:ring-blue-200 outline-none" + (validationErrors[component.props.key] ? "border-red-500" : "border-gray-300") + " " + (component.type === "number" ? "text-right" : ""),
              ...
              onInput: (e) => modelInput.value = e.target.value
            }),
            validationErrors[component.props.key] ? h("span", { class: "text-xs text-red-500 mt-1" }, validationErrors[component.props.key]) : null
          ]);
        }
        case "select":
          if (!(component.props.key in formData.value)) formData.value[component.props.key] = "";
        ...
        case "boolean": {
          ...
          return h("div", { class: "flex items-center mb-3 space-x-2" }, [
            h("input", {
              ...
              onChange: (e) => modelCheckbox.value = e.target.checked,
    ...
    function renderTabs(component) {
      ...
      return h(
        ...
        {
          content: ({ item }) => {
            const realTab = item.raw;
            if (!realTab?.children) return h("div", "No content");
            return h(
              "div",
              realTab.children.map((child) => {
    ...
    function renderCallOther(component) {
      ...
      if (type === "table") {
        const tableObj = tables.value.find((t2) => t2.props.key === key);
    ...
    function validateAllFields() {
      ...
      parsedSchema.value.components.forEach((comp) => {
    ...
    async function saveData(key) {
      try {
        ...
        dataForm.append("search", "true");
        const payload = { ...toRaw(formData.value) };
        for (const key2 in payload) {
          const val = payload[key2];
          if (val !== void 0 && val !== null) {
            if (typeof val === "object") {
              dataForm.append(key2, JSON.stringify(val));
            } else if (typeof val === "boolean") {
              dataForm.append(key2, val ? 1 : 0);
            } else {
              dataForm.append(key2, val);
            }
          }
        }
        const res = await Api.post("admin/execute-flow", dataForm);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><!--[-->`);
      ssrRenderList(parsedSchema.value, (value, index) => {
        _push(`<div>`);
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(renderContainer(value)), null, null), _parent);
        _push(`</div>`);
      });
      _push(`<!--]-->`);
      if (isUploading.value) {
        _push(`<div class="mt-2 w-full bg-gray-200 h-2 rounded overflow-hidden"><div class="bg-green-500 h-2" style="${ssrRenderStyle({ width: uploadProgress.value + "%" })}"></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      ssrRenderList(modals.value, (value, index) => {
        _push(`<div>`);
        if (unref(modalRefs)?.[value.props.key]) {
          _push(ssrRenderComponent(unref(_sfc_main$7), {
            fullscreen: "",
            open: unref(modalRefs)[value.props.key],
            "onUpdate:open": ($event) => unref(modalRefs)[value.props.key] = $event,
            ...
            body: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(renderContainer(value.children)), null, null), _parent2, _scopeId);
              } else {
                return [
                  (openBlock(), createBlock(resolveDynamicComponent(renderContainer(value.children))))
                ];
              }
            }),
            footer: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(ssrRenderComponent(unref(_sfc_main$8), {
                  class: "btnSecondary",
                  label: unref(t)("CLOSE"),
                  onClick: ($event) => close(value.props.key)
                }, null, _parent2, _scopeId));
                _push2(ssrRenderComponent(unref(_sfc_main$8), {
                  class: "btnPrimary",
                  label: unref(t)("SAVE"),
                  onClick: ($event) => saveData(value.props.key)
                }, null, _parent2, _scopeId));
                _push2(`</div>`);
              } else {
                return [
      ...
      _push(`<!--]--><input type="file" class="hidden" accept=".xls,.xlsx"><!--]-->`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/FormRender.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_0 = Object.assign(_sfc_main, { __name: "FormRender" });

export { __nuxt_component_0 as _, _sfc_main$8 as a };
//# sourceMappingURL=FormRender-rRLN5gfz.mjs.map
